...
class Mainstreethost_DynamicOriginShipping_Block_Adminhtml_Origin_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    protected function _prepareCollection()
    {
         ...
         */
        $collection = Mage::getResourceModel('dos/origin_collection');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('state', array(
            'header' => $this->_getHelper()->__('State'),
            'type' => 'options',
            'index' => 'state',
            'options' => Mage::helper('dos')->GetRegions(TRUE),
        ));

        $this->addColumn('zipcode', array(
            'header' => $this->_getHelper()->__('Zip Code'),
            'type' => 'text',
            'index' => 'zipcode',
        ));
